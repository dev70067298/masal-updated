        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-md-12">
                <div class="card table-card">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="{{asset('img/profile.png')}}" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                                    <h6>{{$research->name}}</h6>
                                                    <p class="text-muted m-b-0">{{$research->email}}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{$research->name}}</td>
                  ...
                  <label class="badge badge-light-danger">Disable</label> </td>
                  @endif
                  @if($research->status == 0)
                  <label class="badge badge-light-primary">Pending</label> </td>
                  @endif
