...
public function report(){
    ...
    // $queryBuilder = orderdata::select(['id', 'product_name', 'total_price', 'paid_by'])->get();
    // $columns = ['ID', 'PRODUCT NAME','TOTAL PRICE','PAID BY'];
    // PdfReport::of($queryBuilder, $columns)
    //      ->withoutManipulation()
    //      ->make();
}
public function paidorder(){
    ...
    $order = orderdata::get();
    return view('buyer.paidorder')->with(array('order'=>$order));
